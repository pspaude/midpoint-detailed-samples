...
class ScriptedSqlFilterVisitor implements FilterVisitor<String, Void> {
    ...
    ScriptedSqlFilterVisitor(Map<String, Object> params, String uidColumn, String nameColumn, ColumnPrefixMapper columnMapper, Class<?> uidType, String logPrefix) {
        this.params = params
    ...
    private String visitAttributeFilter(AttributeFilter filter, String type) {
        ...
        LOG.info(logPrefix + "Visiting attribute filter, query {0}, uidcolumn {1}, nameColumn {2}", query, uidColumn, nameColumn)
        ...
        LOG.info(logPrefix + "Filter translated to: {0}, with parameters {1}", where, params)
